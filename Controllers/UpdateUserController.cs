...
namespace QL_CuaHangBanThuocTruSau.Controllers {
    public class UpdateUserController {
        ...
        /// </summary>
        public string HandleUpdateUser (int userId, string password, string fullName, string role, bool status) {
            // 1. Validation
            ...
            // 2. Gọi BUS
            bool result = _userBUS.UpdateUserInfo (userId, password, fullName, role, status);
