...
namespace QL_CuaHangBanThuocTruSau.Controllers {
    public class AddUserController {
        ...
        public string HandleAddUser (string username, string password, string fullName, string role) {
            ...
            bool isSuccess = _userBUS.AddNewUser (username, password, fullName, role);
