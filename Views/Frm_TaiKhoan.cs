    ...
    public partial class Frm_TaiKhoan : Form {
        ...
        private void dgvUsers_CellPainting (object sender, DataGridViewCellPaintingEventArgs e) {
            ...
            if (e.ColumnIndex == dgvUsers.Columns["colEdit"].Index || e.ColumnIndex == dgvUsers.Columns["colDelete"].Index)
            {
                ...
                string iconText = isDelete ? "🗑" : "✎";
                Color iconColor = isDelete ? Color.FromArgb (220, 38, 38) : Color.FromArgb (79, 70, 229);
                
                using (var font = new Font ("Segoe UI", 12))
                {
                    var textSize = e.Graphics.MeasureString (iconText, font);
                    e.Graphics.DrawString (iconText, font, new SolidBrush (iconColor), 
