...
namespace QL_CuaHangBanThuocTruSau.DAO {
    public class DashboardDAO {
        ...
        public dynamic GetDashboardSummary () {
            ...
            var newOrdersToday = _context.Orders.Count (o => DbFunctions.TruncateTime (o.OrderDate) == today);
            
            // Tính công nợ khách hàng (Amount dương là nợ, âm là đã trả - tùy thuộc vào logic của bạn, giả sử Sum là nợ còn lại)
